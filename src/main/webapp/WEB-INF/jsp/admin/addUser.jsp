...
<head>
    ...
    <link rel="shortcut icon" href="/resources/register/ico/favicon.png">
                    ...
                    <form role="form" action="/admin/addUser" method="post" class="registration-form">
                        ...
                        <fieldset>
                            ...
                            <div class="form-bottom">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-last-name">Account</label>
                                    <input type="text" name="account" placeholder="Account..." class="form-last-name form-control" id="form-last-name">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-about-yourself">Phone</label>
                                    <textarea name="phone" placeholder="phone..."
                        ...
                        <fieldset>
                            ...
                            <div class="form-bottom">
                                <div class="form-group">
                                    <label class="sr-only" for="form-email">Sex</label>
                                    <input type="text" name="sex" placeholder="Sex..." class="form-email form-control" id="form-email">
                                </div>
                                <div class="form-group">
                        ...
                        <fieldset>
                            ...
                            <div class="form-bottom">
                                <div class="form-group">
                                    <label class="sr-only" for="form-facebook">Age</label>
                                    <input type="text" name="age" placeholder="Age..." class="form-facebook form-control" id="form-facebook">
                                </div>
                                <div class="form-group">
