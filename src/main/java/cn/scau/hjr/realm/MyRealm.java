...
public class MyRealm extends AuthorizingRealm {
    ...
    //注入userService//2017 7/20 by hjr
    @Resource
...
//      simpleAuthorInfo.addStringPermissions(permissionList);
        ...
        {
            Set<String> roles=userService.getUserRoles(currentAccount);
            simpleAuthorInfo.addRoles(roles);
            simpleAuthorInfo.addStringPermissions(userService.getUserPermissions(currentAccount));
